    ...
    return (
        <div className='flex flex-col mt-12'>
            ...
            <form onSubmit={generateCanvas} className='py-4 flex flex-col'>
                ...
                <input name="year" type="text" placeholder="Release year..." className={inputStyle} required />
                ...
                formData.rating ?
                    <>
                        ...
                        <div className='flex flex-col self-center items-center justify-center my-12 sm:w-inherit' id='canvasWrapper'>
                            ...
                            />
                            <button onClick={() => downloadCanvas(canvasRef.current, 'title')} className={buttonStyle}>Download</button>
                        </div>
                    </> : null
            }
        </div>
